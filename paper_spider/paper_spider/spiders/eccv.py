...
class ECCVPaperSpider(scrapy.Spider):
    name = "eccv_paper_spider"

    def __init__(self, year=None, *args, **kwargs):
        super(ECCVPaperSpider, self).__init__(*args, **kwargs)
        self.start_urls = [f"https://www.ecva.net/papers.php"]
        self.year = year

    def parse(self, response):  # noqa
        paper_links = None
        # Probably, this xpath will be change at 2026 ...
        if self.year == "2024":
            ...
            paper_links = response.xpath("/html/body/main/div[2]/div[3]/div/dl/dt/a/@href").getall()
        elif self.year == "2018":
            paper_links = response.xpath("/html/body/main/div[2]/div[4]/div/dl/dt/a/@href").getall()
